...
if client_id and access_token:
    try:
        ...
        raw_chain_data = {
            "Strike": [
                75200, 75300, 75400, 75500, 75600, 75700, 75800, 75900, 76000,
                76100, 76200, 76300, 76400, 76500, 76600, 76700, 76800, 76900,
                77000, 77100, 77200,
            ],
            "Call_LTP": [
                1070, 970, 870, 770, 670, 570, 470, 371.85, 271.70, 177.45,
                89.10, 30.25, 8.45, 2.95, 1.70, 0.90, 0.50, 0.30, 0.20, 0.10, 0.05,
            ],
            "Put_LTP": [
                0.05, 0.10, 0.20, 0.30, 0.50, 0.90, 1.20, 1.80, 2.75, 6.00,
                19.90, 62.65, 140.80, 234.90, 333.75, 430.00, 530.00, 630.00,
                730.00, 830.00, 930.00,
            ],
        }
        ...
        if multiplier >= 2.0:
            ...
            st.info(
                f"⚖️ **NEUTRAL MARKET:** Multiplier is **{multiplier:.2f}x**."
            )
